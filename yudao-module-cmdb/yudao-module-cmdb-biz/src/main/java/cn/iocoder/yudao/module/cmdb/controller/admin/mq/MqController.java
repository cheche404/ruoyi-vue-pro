    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<MqImportExcelVO> list = Arrays.asList(
          MqImportExcelVO.builder().cloudArea("aliyun").env("paas").center("").team("").user("").promoter("")
            .host("mq-paas.digiwincloud.com.cn").docker("N").nodesInfo("192.168.9.208").clusterName("阿里云paas-mq")
          ...
          MqImportExcelVO.builder().cloudArea("azure").env("prod").center("").team("").user("").promoter("")
            .host("mq.digiwincloud.com").docker("N").nodesInfo("192.168.0.100").clusterName("微软云生产mq")
          ...
          MqImportExcelVO.builder().cloudArea("huawei").env("prod").center("").team("").user("").promoter("")
            .host("rmq-hw.digiwincloud.com.cn").docker("N").nodesInfo("10.0.157.127,10.0.157.127,10.0.231.74").clusterName("athena生产rmq")
