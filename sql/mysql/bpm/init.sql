...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '流程分类';
...
CREATE TABLE `bpm_process_instance_copy`  (
                                              ...
                                              `activity_id` varchar(64)  DEFAULT NULL COMMENT '任务主键',
                                              `activity_name` varchar(64)  DEFAULT NULL COMMENT '任务名称',
